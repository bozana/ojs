...
class ExportPublishedPublicationsListGridHandler extends GridHandler
{
    ...
    public function initialize($request, $args = null)
    {
        ...
        if (!$this->_plugin) {
            ...
            // loadPlugin calls instantiatePlugin, that considers $pluginName to be plugin folder name and
            // assumes class is $pluginName.'Plugin' (which is only the case for generic plugins) or
