...
class StatsIssueHandler extends APIHandler
{
     ...
     */
    public function getManyToc(\Slim\Http\Request $slimRequest, \PKP\core\APIResponse $response, array $args): \PKP\core\APIResponse
    {
        $request = $this->getRequest();
    ...
    public function get(\Slim\Http\Request $slimRequest, \PKP\core\APIResponse $response, array $args): \PKP\core\APIResponse
    {
        ...
        return $response->withJson([
            ...
            //'totalArticleViews' => $totalSubmissionViews,
     ...
     * month or day
     */
    public function getToc(\Slim\Http\Request $slimRequest, \PKP\core\APIResponse $response, array $args): \PKP\core\APIResponse
    {
        $request = $this->getRequest();
    ...
    protected function getCSVItem(int $issueId, int $tocViews, int $issueGalleyViews, int $totalViews): array
    {
        ...
        // Stats may exist for deleted issues
        $identification = '';
