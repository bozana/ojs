...
{
    /**
     * @var array Include records for one of these object types: ASSOC_TYPE_ISSUE, ASSOC_TYPE_ISSUE_GALLEY
     */
    protected array $assocTypes = [];

    /** @var array Include records for these issues */
    protected array $issueIds = [];

    /** @var array Include records for these issues galleys */
     ...
     *
     * @return \APP\services\queryBuilders\StatsIssueQueryBuilder
     */
    public function filterByIssues($issueIds): self
    {
     ...
     * Set the issues to get records for
     *
     * @param array|int $issueGalleyIds
     *
     * @return \APP\services\queryBuilders\StatsIssueQueryBuilder
     */
    public function filterByIssueGalleys($issueGalleyIds): self
    {
