...
{elseif $pubObject instanceof ArticleGalley}
    <form class="pkp_form" id="publicIdentifiersForm" method="post" action="{url component="grid.articleGalleys.ArticleGalleyGridHandler" op="updatePubIds" submissionId=$pubObject->getSubmissionId() representationId=$pubObject->getId() escape=false}">
{elseif $pubObject instanceof SubmissionFile}
    <form class="pkp_form" id="publicIdentifiersForm" method="post" action="{url component="api.file.ManageFileApiHandler" op="updatePubIds" fileId=$pubObject->getFileId() revision=$pubObject->getRevision() submissionId=$pubObject->getSubmissionId() stageId=$stageId fileStageId=$pubObject->getFileStage() escape=false}">
