...
<div id="editArticleGalleyMetadataTabs">
    <ul>
        ...
        <li><a href="{url router=$smarty.const.ROUTE_COMPONENT op="pubIds" submissionId=$submissionId representationId=$representationId}">{translate key="submission.identifiers"}</a></li>
    </ul>
</div>
