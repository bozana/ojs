...
class CounterReport
{
    ...
    protected function filterForContext($filters)
    {
        ...
        if ($journalId) {
            if (isset($filters[StatisticsHelper::STATISTICS_DIMENSION_CONTEXT_ID]) && $filters[StatisticsHelper::STATISTICS_DIMENSION_CONTEXT_ID] != $journalId) {
            ...
            $filters[StatisticsHelper::STATISTICS_DIMENSION_CONTEXT_ID] = $journalId;
        }
        return $filters;
    }
