...
class CounterReportJR1 extends CounterReport
{
    ...
    public function getReportItems($columns = [], $filters = [], $orderBy = [], $range = null)
    {
        ...
        $validOrder = [StatisticsHelper::STATISTICS_DIMENSION_CONTEXT_ID => StatisticsHelper::STATISTICS_ORDER_DESC, StatisticsHelper::STATISTICS_DIMENSION_MONTH => StatisticsHelper::STATISTICS_ORDER_ASC];
        // TODO: range
