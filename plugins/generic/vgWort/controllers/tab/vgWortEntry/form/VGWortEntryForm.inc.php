...
/**
 * @file plugins/generic/vgWort/controllers/tab/vgWortEntry/form/VGWortEntryForm.inc.php
 *
 * Copyright (c) 2003-2013 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class VGWortEntryForm
 * @ingroup controllers_tab_vgWortEntry_form_VGWortEntryForm
 *
 * @brief Displays a VG Wort entry form.
 */

import('lib.pkp.classes.form.Form');

class VGWortEntryForm extends Form {
	 ...
	 */
	function VGWortEntryForm($submissionId, $userId, $stageId = null, $formParams = null) {
		parent::Form('plugins/controllers/tab/vgWortEntry/form/vgWortFormFields.tpl');
