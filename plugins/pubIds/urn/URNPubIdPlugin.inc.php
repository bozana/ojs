...
class URNPubIdPlugin extends PubIdPlugin {
	...
	function getFormFieldNames() {
		return array('urnSuffix', 'assignURN', 'assignIssueObjectsURNs');
	}
	...
	function getLinkActions($pubObject) {
		...
		if (is_a($pubObject, 'Issue')) {
			...
			$linkActions['assignIssueObjectsPubIdsLinkActionURN'] = new LinkAction(
					'issueObjectsPubIdActions',
					new RemoteActionConfirmationModal(
							__('plugins.pubIds.urn.editor.assignIssueObjectsURN.confirm'),
							__('common.delete'),
							$request->url(null, null, 'issueObjectsPubIdActions', null, $userVars),
							'modal_delete'
							),
					__('plugins.pubIds.urn.editor.assignIssueObjectsURN'),
					'delete'
					);
			// Unmark issue objects for pub ids assignment
			$userVars['actionType'] = 'unassignIssueObjectsPubIds';
			$linkActions['unassignIssueObjectsPubIdsLinkActionURN'] = new LinkAction(
					'issueObjectsPubIdActions',
					new RemoteActionConfirmationModal(
							__('plugins.pubIds.urn.editor.unassignIssueObjectsURN.confirm'),
							__('common.delete'),
							$request->url(null, null, 'issueObjectsPubIdActions', null, $userVars),
							'modal_delete'
							),
					__('plugins.pubIds.urn.editor.unassignIssueObjectsURN'),
					'delete'
					);
		}
