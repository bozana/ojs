...
class DOIPubIdPlugin extends PubIdPlugin {
	...
	function getFormFieldNames() {
		return array('doiSuffix', 'assignDoi', 'assignIssueObjectsDois');
	}
	...
	/**
	 * @copydoc PKPPubIdPlugin::getAssignIssueObjectsFormFieldName()
	 */
	function getAssignIssueObjectsFormFieldName() {
		return 'assignIssueObjectsDois';
	}
	...
	function getLinkActions($pubObject) {
		...
		$userVars['actionType'] = 'clearPubId';
		// Clear object pub id
		...
		if (is_a($pubObject, 'Issue')) {
			...
			$userVars['actionType'] = 'clearIssueObjectsPubIds';
			$linkActions['clearIssueObjectsPubIdsLinkActionDoi'] = new LinkAction(
					'issueObjectsPubIdActions',
					new RemoteActionConfirmationModal(
							__('plugins.pubIds.doi.editor.clearIssueObjectsDoi.confirm'),
							__('common.delete'),
							$request->url(null, null, 'issueObjectsPubIdActions', null, $userVars),
							'modal_delete'
							),
					__('plugins.pubIds.doi.editor.clearIssueObjectsDoi'),
					'delete'
					);
			// Mark issue objects for pub ids assignment
			$userVars['actionType'] = 'assignIssueObjectsPubIds';
			$linkActions['assignIssueObjectsPubIdsLinkActionDoi'] = new LinkAction(
					'issueObjectsPubIdActions',
					new RemoteActionConfirmationModal(
							__('plugins.pubIds.doi.editor.assignIssueObjectsDoi.confirm'),
							__('common.delete'),
							$request->url(null, null, 'issueObjectsPubIdActions', null, $userVars),
							'modal_delete'
							),
					__('plugins.pubIds.doi.editor.assignIssueObjectsDoi'),
					'delete'
					);
			// Unmark issue objects for pub ids assignment
			$userVars['actionType'] = 'unassignIssueObjectsPubIds';
			$linkActions['unassignIssueObjectsPubIdsLinkActionDoi'] = new LinkAction(
					'issueObjectsPubIdActions',
					new RemoteActionConfirmationModal(
							__('plugins.pubIds.doi.editor.unassignIssueObjectsDoi.confirm'),
							__('common.delete'),
							$request->url(null, null, 'issueObjectsPubIdActions', null, $userVars),
							'modal_delete'
							),
					__('plugins.pubIds.doi.editor.unassignIssueObjectsDoi'),
					'delete'
					);
		}
