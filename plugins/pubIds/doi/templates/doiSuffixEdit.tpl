 ...
 *}
	...
	{if $pubObjectType == 'Issue' || $pubObjectType == 'Article'}
		{url|assign:pubIdAssignmentsGridUrl router=$smarty.const.ROUTE_COMPONENT component="grid.pubIds.PubIdAssignmentsGridHandler" op="fetchGrid" pubIdType=$pubIdPlugin->getPubIdType() pubObjectType=$pubObjectType pubObjectId=$pubObject->getId() escape=false}
		{load_url_in_div id="pubIdAssignmentsGridContainer" url=$pubIdAssignmentsGridUrl}
	{/if}
